...
\newcommand{\dimEnvN}{5000}
\newcommand{\dimEnvCP}{0.060}
...
\newcommand{\filterMeanUs}{145}    % full-bisection path, median per projection [us] (bench/timing.py)
...
\newcommand{\gainGrid}{63}         % gain settings swept
\newcommand{\gainRuns}{3969}       % gain settings x aged cooling-faulted cells
