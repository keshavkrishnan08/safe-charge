...
\SI{\filterMemB}{B} of state and constants with no dynamic allocation, \SI{\filterWorstMs}{ms}
worst-case in the reference implementation and orders of magnitude inside the \SI{30}{s} step. The
